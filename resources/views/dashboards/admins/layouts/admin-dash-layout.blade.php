...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="hospital_name">
          <p class="text-success"> {{ $LoggedUserInfo['hospital_name'] }} </p>
          <!-- <p class="text-success"> {{ $LoggedUserInfo['id'] }} </p> -->
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="">hospitaldiaryweb.com</a>.</strong>
    All rights reserved.
