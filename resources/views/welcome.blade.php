...
<title>Hospital Diary Web</title>
      ...
      <div class="navbar-header">
	    ...
	    <div id="main-nav" class="collapse navbar-collapse navStyle">
			<ul class="nav navbar-nav" id="mainNav">
			  ...
			  <li><a href="admin_login" class="scroll-link">Sign In as Admin</a></li>
			  <li><a href="user_login" class="scroll-link">Sign In As User</a></li>
			</ul>
      </div>
	 </nav>
    </div>
        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont zoomIn wow animated"> 
              <h2>We provide <strong>best</strong> hospital services</h2>
          ...
          <div class="col-lg-7 col-sm-5">
			<img src="img/national-cancer-institute.jpg" class="zoomIn wow animated" alt="" />
		  </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">ICU</h3>
        ...
        <div class="col-lg-4 borderLeft">			
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">CCU</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">Oxygen Cylinder</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
      </div>
	   <div class="row borderTop">
        <div class="col-lg-4 mrgTop">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">Pulse Oxymeter</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft mrgTop">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">Blood Bank</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft mrgTop">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">Medical Tests</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
      </div>
    ...
    <div id="filters" class="sixteen columns">
      <ul class="clearfix">
        ...
        <li><a class="" href="#" data-filter=".prototype">
          <h5>Gynecologist & Surgeon</h5>
          </a></li>
        <li><a class="" href="#" data-filter=".design">
          <h5>Mental Disorder, Drug Addiction & Psychiatry Specialist</h5>
          </a></li>
        <li><a class="" href="#" data-filter=".android">
          <h5>Diabetes, Hormone, Thyroid Specialist & Endocrinologist</h5>
          </a></li>
        <li><a class="" href="#" data-filter=".appleIOS">
          <h5>Brain, Spine & Neurology Specialist</h5>
          </a></li>
        <li><a class="" href="#" data-filter=".web">
          <h5>Anaesthesia & ICU Specialist</h5>
          </a></li>
      </ul>
    </div>
    <!--/Portfolio Filters --> 
